package FashionFlow.api_gateway.routes;
...
public class Routes {
    ...
    //the function of filter here is before we call the actual path it calls to http://localhost:8080/api-docs where we expose the api documentation in json format
    @Bean
